...
{% include picture.html src: '/assets/images/about/armenia.png', alt: 'A map of Armenia', clickable: false %}
...
Gaming is just one of the many ways I like to spend my free time. Like lots of people, I also enjoy listening to music—it's an incredibly therapeutic and creative outlet for me. Some of my favorite genres include classic rock, alt and post rock, and indie, but I like to keep an open mind and listen to whatever I stumble upon now and then. I especially like music written by Lana Del Rey, Arctic Monkeys, Radiohead, Steven Wilson, Pink Floyd, and Godspeed You! Black Emperor.
