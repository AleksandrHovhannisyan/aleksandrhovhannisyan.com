...
{% include img.html img="escaped-code.png" alt="Inspecting an HTML element with Chrome dev tools." %}
...
{% include img.html img="improvements.gif" alt="Inspecting the code block headers on my website" %}
