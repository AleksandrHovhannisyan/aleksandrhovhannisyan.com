...
{% include img.html src: "riebeck-nomai.jpg", alt: "Riebeck, an NPC, comments on the Nomai. Her dialogue reads: 'An alien race lived in this solar system long before our species even existed! How could I not want to see what their civilization was like?'" %}
...
{% include img.html src: "ship-log.jpg", alt: "The ship log, consisting of photos of in-game items and locations. These tiles are connected to each other with lines. Each tile represents a key piece of information in the game. Some tiles have a question mark as their image, representing information the player has yet to uncover." %}
...
{% include img.html src: "campfire.jpg", alt: "The player roasts marshmallows over a campfire at the starting area of the game. Another NPC rests on a log opposite the player." %}
...
{% include img.html src: "sun.jpg", alt: "The sun in Outer Wilds, a massive, bright, orange ball of fire and light. A moon is partially eclipsed by the sun." %}
...
{% include img.html src: "riebeck-black-hole.jpg", alt: "Riebeck, an NPC, comments on Brittle Hollow, the planet she inhabits: 'Oh wow, where shouldn't you explore here? Um, not the black hole, actually. That's... very no.'" %}
...
{% include img.html src: "sunless-city-sand.jpg", alt: "When the sand rises, there's no escaping the Sunless City. One of the doorways is partially blocked off, preventing the player from leaving their current room." %}
...
{% include figure.html src: "riebeck-yelling.jpg", alt: "Riebeck, one of the NPCs, comments on one of your discoveries. Her dialogue reads: 'AHHH! That doesn't make any sense! I don't understand! I am very excited for you, though! P-please stop yelling!", caption: "Riebeck is adorable, and proof that you don't need voice acting to convey emotion and... well, voice!" %}
...
{% include img.html src: "timber-hearth.jpg", alt: "Timber Hearth, the player's home planet. The sun shines brightly overhead, with a clear blue sky in the background. Two large towers can be seen in the distance. Pine trees surround the planet's main encampment, at the center of which a geyser shoots a jet of water into the air." %}
...
{% include img.html src: "dark-bramble.jpg", alt: "The player begins to enter Dark Bramble aboard their ship. The planet's interior is shrouded in a thick, dark mist that makes it difficult to see. Orbs of light glow faintly in the distance." %}
...
{% include img.html src: "hourglass-twins.jpg", alt: "Two planets, named the Hourglass Twins, revolve about one another. The Ember Twin is siphoning a column of sand from the Ash Twin. As the Ash Twin diminishes in size, various manmade structures can be seen exposed above the surface." %}
...
{% include img.html src: "black-hole.jpg", alt: "The player falls into the core of Brittle Hollow, where a black hole can be seen." %}
...
{% include img.html src: "giants-deep.jpg", alt: "The player flies just a few feet above the ocean of Giant's Deep, a planet ravaged by storms and water spouts." %}
...
{% include img.html src: "supernova.jpg", alt: "The sun at the center of the player's solar system collapses under its own gravity in a violent supernova of bright blue and white light. Darkness envelops the remainder of the screen." %}
...
{% include img.html src: "observatory.jpg", alt: "An exhibit at the Observatory describing the death of the solar system's sun. A model of the sun is captioned: 'At the end of its lifespan, our sun collapsed under its own gravity and then exploded in a violent supernova.'" %}
...
{% include img.html src: "nomai-statue.jpg", alt: "A wall-mounted statue at the Eye of the Universe depicts a Nomai inhabitant. The caption reads: 'The Nomai never got to see it for themselves, but thanks to their efforts and technology, a Hearthian was able to reach the Eye of the universe.'" %}
...
{% include figure.html src: "anglerfish-perish.jpg", alt: "The Exploratory in the Eye of the Universe houses an Anglerfish model in a glass case. The caption reads: 'Of all the lifeforms who will perish in the oncoming death of the universe, we will miss the anglerfish the least.'", caption: "Amen to that!" %}
...
{% include img.html src: "hope.jpg", alt: "The player reads Nomai conversations etched onto a stone wall. A character named Ramie says, 'I believe we can still find a way to create a supernova, my friend. Don't lose hope!'" %}
