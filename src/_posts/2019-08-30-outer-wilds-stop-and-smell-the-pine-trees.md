...
{% include img.html src: "outer-wilds.jpg", alt: "An in-game photo showing the founders of the Outer Wilds space exploration program." %}
...
{% include img.html src: "rieback-nomai.jpg", alt: "Rieback, an NPC, commenting on the Nomai." %}
...
{% include img.html src: "nomai-writing.jpg", alt: "Text written by the Nomai. The player must decipher it to learn more about them." %}
...
{% include img.html src: "ship-log.jpg", alt: "The ship log charts all of your discovers and how they're related." %}
...
{% include img.html src: "campfire.jpg", alt: "Roasting marshmallows over a campfire." %}
...
{% include img.html src: "sun.jpg", alt: "The sheer scale of the planets and the sun is overwhelming." %}
...
{% include img.html src: "rieback-black-hole.jpg", alt: "Rieback, one of the NPCs, suggests that you not visit the black hole." %}
...
{% include img.html src: "sunless-city.jpg", alt: "The Sunless City, built in the caverns of Ember Twin." %}
...
{% include img.html src: "sunless-city-sand.jpg", alt: "When the sand rises, there's no escaping the Sunless City." %}
...
{% include figure.html src: "rieback-yelling.jpg", alt: "An example of the excellent use of writing to convey emotions.", caption: "Rieback is adorable, and proof that you don't need voice acting to convey emotion and... well, voice!" %}
...
{% include img.html src: "timber-hearth.jpg", alt: "Timber Hearth, your home planet." %}
...
{% include img.html src: "dark-bramble.jpg", alt: "Dark Bramble is shrouded in thick mist, with bulbs of glowing light in the distance." %}
...
{% include img.html src: "hourglass-twins.jpg", alt: "The Hourglass Twins, with the Ash Twin dumping sand onto the Ember Twin." %}
...
{% include img.html src: "black-hole.jpg", alt: "Falling into the Black Hole at the core of Brittle Hollow." %}
...
{% include img.html src: "giants-deep.jpg", alt: "Giant's Deep is a planet ravaged by storms and water spouts." %}
...
{% include img.html src: "supernova.jpg", alt: "Your solar system's sun collapses under its own gravity in a violent supernova." %}
...
{% include img.html src: "observatory.jpg", alt: "An exhibit at the Observatory describing the death of our solar system's sun." %}
...
{% include img.html src: "nomai-statue.jpg", alt: "A Nomai statue at the Eye of the Universe comments on your success, and the Nomai's failure." %}
...
{% include figure.html src: "anglerfish-perish.jpg", alt: "The Hearthians reflect on life without the pesky anglerfish.", caption: "Amen to that!" %}
...
{% include img.html src: "hope.jpg", alt: "The Nomai never gave up hope on completing their mission." %}
...
{% include img.html src: "end-credits.jpg", alt: "A universe begins life anew." %}
