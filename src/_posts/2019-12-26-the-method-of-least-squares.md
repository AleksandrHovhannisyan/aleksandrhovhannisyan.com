...
thumbnail: https://images.unsplash.com/photo-1616628188524-65a2deb4f06f?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=600&h=600&q=80
---
...
{% include img.html src: "overdetermined-system.jpg", alt: "The graph of the four equations above." %}
...
{% include img.html src: "data.png", alt: "Plotting the five data points we were given." %}
...
{% include img.html src: "least-squares-visualized.jpg", alt: "A graph of Ax=b." %}
...
{% include img.html src: "dimensions.jpg", alt: "The dimensions of A^TAx = A^Tb" %}
...
{% include img.html src: "qr-factorization.jpg", alt: "Visualization of the equation Rx = Q^Tb" %}
