...
{% include picture.html img="static-site-generator.png" alt="A static site generator spits out a compiled, well-structured, fully functioning site." %}
...
{% include picture.html img="new-repo.png" alt="Click the green new button to create a repository." %}

Enter the name of your repository. It needs to be your GitHub username followed by `.github.io`:

{% include picture.html img="create-repo.png" alt="Type in the name of your new repository." %}
...
{% include picture.html img="directory-structure.jpg" alt="Jekyll starter files." %}
...
{% include picture.html img="themes.jpg" alt="The three Jekyll starter themes." %}
...
{% include picture.html img="hello-jekyll.png" alt="Hello, Jekyll" %}
...
{% include picture.html img="webrick.png" alt="The WEBrick server for our Jekyll site." %}
...
{% include picture.html img="webrick2.png" alt="The WEBrick server for our Jekyll site." %}
...
{% include picture.html img="about.gif" alt="Navigating to the About page." %}
...
{% include picture.html img="post.png" alt="A sample blog post." %}
...
{% include picture.html img="date.png" alt="A sample blog post showing its date in the body." %}
...
{% include picture.html img="default-layout.gif" alt="The default layout." %}
...
{% include picture.html img="collapsed-layout.png" alt="The starter blog post has a collapsed layout." %}
...
{% include picture.html img="post-layout.png" alt="The post layout." %}
...
{% include picture.html img="styled.png" alt="The styled version of the site." %}
...
{% include picture.html img="mockup.png" alt="Mockups of project cards and skills" %}
...
{% include picture.html img="google-search-console.png" alt="Google Search Console statistics for my site." %}
...
{% include picture.html img="add-property.png" alt="Adding a Google Search Console property." %}

When prompted to select a property type, choose the `URL prefix` option and enter the full URL of your site on GitHub Pages:

{% include picture.html img="property-type.png" alt="Selecting the type of property in Google Search Console." %}
...
{% include picture.html img="verify-ownership.png" alt="Verify ownership of your Google Search Console property." %}
