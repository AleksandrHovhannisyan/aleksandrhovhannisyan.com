...
{% include picture.html img="udemy-courses.jpg" alt="Two of the Udemy courses I once purchased but never finished." %}
...
{% include picture.html img="programming-woes.jpg" alt="Posts on r/programming from people who feel discouraged and overwhelmed." %}
