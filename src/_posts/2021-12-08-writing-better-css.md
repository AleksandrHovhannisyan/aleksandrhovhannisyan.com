...
<div class="circle flex-center text-center" style="font-family: var(--ff-title); background: var(--pill-bg-color); max-width: {{ squareDemoMaxWidth }}; padding: var(--sp-5); color: var(--color-text-emphasis);" aria-hidden="true">I'm a circle.</div>
