...
<div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 0.625rem; font-family: var(--ff-title); max-width: 400px; margin-left: auto; margin-right: auto;" aria-hidden="true">
  {%- for i in (1..9) -%}
...
<div style="font-family: var(--ff-title); background: var(--pill-bg-color); aspect-ratio: 1; max-width: {{ squareDemoMaxWidth }}; margin-left: auto; margin-right: auto; display: flex; justify-content: center; align-items: center; text-align: center; padding: var(--sp-5); color: var(--color-text-emphasis);" aria-hidden="true">I'm a square. My max width is {{ squareDemoMaxWidth }}.</div>
...
<div class="circle" style="font-family: var(--ff-title); background: var(--pill-bg-color); max-width: {{ squareDemoMaxWidth }}; margin-left: auto; margin-right: auto; display: flex; justify-content: center; align-items: center; text-align: center; padding: var(--sp-5); color: var(--color-text-emphasis);" aria-hidden="true">I'm a circle.</div>
