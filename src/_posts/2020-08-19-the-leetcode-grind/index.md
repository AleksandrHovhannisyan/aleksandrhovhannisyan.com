...
{% include img.html src: "./images/leetcode.png", alt: "Leetcode has a list of DSA problems that you can solve" %}
...
{% include img.html src: "./images/reddit.png", alt: "Reddit is obssessed with the Leetcode grind" %}
