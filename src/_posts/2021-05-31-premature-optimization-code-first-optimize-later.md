...
description: Don't optimize your code just because you have some vague suspicion that it's slow. Focus on writing readable, well-tested, and well-documented code; optimize it if you run into measurable performance issues.
