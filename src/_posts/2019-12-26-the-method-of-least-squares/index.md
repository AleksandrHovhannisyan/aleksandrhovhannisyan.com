...
{% include img.html src: "./images/overdetermined-system.jpg", alt: "The graph of the four equations above." %}
...
{% include img.html src: "./images/data.png", alt: "Plotting the five data points we were given." %}
...
{% include img.html src: "./images/best-fit.png", alt: "A best-fit line through the points we plotted." %}
...
{% include img.html src: "./images/least-squares-visualized.jpg", alt: "A graph of Ax=b." %}
...
{% include img.html src: "./images/dimensions.jpg", alt: "The dimensions of A^TAx = A^Tb" %}
...
{% include img.html src: "./images/qr-factorization.jpg", alt: "Visualization of the equation Rx = Q^Tb" %}
