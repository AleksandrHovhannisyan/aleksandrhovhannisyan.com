...
{% include img.html img="semantic-html.png" alt="The main pieces of a website can be broken down into semantic elements and groupings" %}
...
{% include img.html img="main.png" alt="The main content region of a website" %}
...
{% include img.html img="header-footer.png" alt="The header and footer HTML elements" %}
...
{% include img.html img="article.png" alt="The article HTML element" %}
...
{% include img.html img="twitter-button.png" alt="Inspecting the Twitter heart button" %}

Gmail also uses divs for its buttons:

{% include img.html img="gmail.png" alt="Inspecting Gmail's refresh button" %}

Facebook's like button is a div with an image inside it:

{% include img.html img="facebook-like.png" alt="Inspecting Facebook's like button" %}

But there are sites that do get this right!

The StackExchange network uses `<button>` elements with nested SVGs:

{% include img.html img="stackoverflow-buttons.png" alt="Inspecting StackOverflow's upvote button" %}

As does the new Reddit interface (the old one is still using divs):

{% include img.html img="reddit.png" alt="Inspecting the Reddit upvote button" %}
...
{% include img.html img="google.png" alt="Inspecting the Google search results page" %}
...
{% include img.html img="twitter-replies.png" alt="Inspecting Twitter replies" %}

So does Reddit, both for its old and new interfaces:

{% include img.html img="reddit-comments.png" alt="Inspecting Reddit comments" %}
...
{% include img.html img="stackoverflow-comments.png" alt="Inspecting comments on a StackOverflow post" %}

And so does Spotify, where songs are rendered in an ordered list:

{% include img.html img="spotify.png" alt="Inspecting a list of songs on Spotify" %}

Here's another great example of using a list properly, this time from GitHub:

{% include img.html img="github-repo-results.png" alt="Inspecting repository search results on GitHub" %}
...
{% include img.html img="github-counter.png" alt="Inspecting a GitHub counter via the Chrome dev tools" %}
...
{% include img.html img="mdn.png" alt="Table describing the various attribute constraints for the ordered list element" %}
...
{% include img.html img="github-time.png" alt="Inspecting a relative date time on GitHub" %}

StackOverflow uses `<time>`:

{% include img.html img="stackoverflow-time.png" alt="StackOverflow uses the time element for the dates of posts" %}

And so does Twitter:

{% include img.html img="twitter-time.png" alt="Twitter uses the time element for the date a tweet was posted" %}
