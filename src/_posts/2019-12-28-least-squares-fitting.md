...
{% include img.html img="data.jpg" alt="Plotting the three data points we were given." %}
...
{% include img.html img="best-fit.jpg" alt="The best-fit line to the data we were given." %}
...
{% include img.html img="data2.jpg" alt="Plotting the four data points we were given." %}
...
{% include img.html img="best-fit2.jpg" alt="The best-fit parabola to the data we were given." %}
