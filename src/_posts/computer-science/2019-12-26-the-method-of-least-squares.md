...
{% include picture.html img="overdetermined-system.jpg" alt="The plot of the four equations above." %}
...
{% include picture.html img="data.png" alt="Plotting the five data points we were given." %}
...
{% include picture.html img="best-fit.png" alt="A best-fit line through the points we plotted." %}
...
{% include picture.html img="least-squares-visualized.jpg" alt="A graph of Ax=b." %}
...
{% include picture.html img="dimensions.jpg" alt="The dimensions of A^TAx = A^Tb" %}
...
{% include picture.html img="qr-factorization.jpg" alt="Visualization of the equation Rx = Q^Tb" %}
