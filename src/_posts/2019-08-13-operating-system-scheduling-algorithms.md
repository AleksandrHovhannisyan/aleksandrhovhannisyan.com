...
{% include picture.html img="first-come.jpg" alt="First come first serve scheduling algorithm." %}
...
{% include picture.html img="shortest-job.jpg" alt="Shortest job first scheduling algorithm." %}
...
{% include picture.html img="shortest-remaining.jpg" alt="Shortest remaining time first scheduling algorithm." %}
...
{% include picture.html img="round-robin.jpg" alt="Round robin scheduling algorithm." %}
...
{% include picture.html img="preemptive-priority.jpg" alt="Preemptive priority scheduling algorithm." %}
