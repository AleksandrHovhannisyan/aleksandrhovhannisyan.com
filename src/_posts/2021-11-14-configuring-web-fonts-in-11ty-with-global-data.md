...
description: Instead of using static font-face declarations for web fonts, take advantage of global data in 11ty to create a single source of truth for fonts and reuse those values throughout your templates and CSS.
