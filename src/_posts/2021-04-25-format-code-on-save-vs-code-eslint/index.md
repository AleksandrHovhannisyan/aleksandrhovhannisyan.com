...
{% include img.html src: "./images/eslint-extension.png", alt: "Viewing the ESLint extension in the VS Code extension marketplace." %}
...
{% include img.html src: "./images/settings.png", alt: "Searching for 'settings' via VS Code's command palette." %}
...
{% include img.html src: "./images/initializing-language-features.png", alt: "The VS Code status bar displays the text Initializing JS/TS language features next to a loading spinner." %}
