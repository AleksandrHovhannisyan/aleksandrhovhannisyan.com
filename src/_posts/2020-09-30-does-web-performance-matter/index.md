...
{% include img.html src: "./images/google-blog.png", alt: "The Lighthouse audit for blog.google.com shows 50 for performance, 74 for accessibility, 79 for best practices, and 98 for SEO." %}

And when you run it on YouTube:

{% include img.html src: "./images/youtube.png", alt: "The Lighthouse audit for youtube.com shows 38 for performance, 90 for accessibility, 86 for best practices, and 98 for SEO." %}

And the Google Cloud Platform landing page:

{% include img.html src: "./images/gcp.png", alt: "The Lighthouse audit for cloud.google.com shows 21 for performance, 91 for accessibility, 86 for best practices, and 82 for SEO." %}
...
{% include img.html src: "./images/bank-of-america.png", alt: "The Lighthouse audit for bankofamerica.com shows 16 for performance, 86 for accessibility, 57 for best practices, and 83 for SEO." %}

The Microsoft Store is apparently not much better:

{% include img.html src: "./images/microsoft-store.png", alt: "The Lighthouse audit for the microsoft store shows 21 for performance, 98 for accessibility, 64 for best practices, and 85 for SEO." %}

Neither is Zoom's landing page:

{% include img.html src: "./images/zoom.png", alt: "The Lighthouse audit for zoom.com shows 28 for performance, 88 for accessibility, 64 for best practices, and 89 for SEO." %}

And neither is Slack's:

{% include img.html src: "./images/slack.png", alt: "The Lighthouse audit for slack.com shows 14 for performance, 94 for accessibility, 64 for best practices, and 92 for SEO." %}

The landing pages of SEO authorities like Ahrefs and Moz are similarly slow:

{% include img.html src: "./images/ahrefs.png", alt: "The Lighthouse audit for ahrefs.com shows 37 for performance, 90 for accessibility, 93 for best practices, and 100 for SEO." %}

{% include img.html src: "./images/moz.png", alt: "The Lighthouse audit for moz.com shows 47 for performance, 89 for accessibility, 79 for best practices, and 91 for SEO." %}
