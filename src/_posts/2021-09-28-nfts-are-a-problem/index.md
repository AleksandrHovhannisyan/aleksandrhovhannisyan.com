...
{% include img.html src: "./images/rock.png", alt: "A monochrome rock drawn in a clipart style.", caption: "This humble rock is probably worth more than you. Source: [Twitter](https://twitter.com/degenharambe/status/1424133878352998401)." %}
...
{% include img.html src: "./images/onement-vi.jpg", alt: "A blue canvas with a white line down the middle.", caption: "Copyright Barnett Newman. Source: [WikiArt](https://www.wikiart.org/en/barnett-newman/onement-vi-1953)." %}
