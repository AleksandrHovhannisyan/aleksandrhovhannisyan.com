...
{% include picture.html img="isshin.png" alt="Isshin Ashina readies his blade as he prepares to fight Sekiro in the final cutscene. The words 'I must destroy you' are captioned on screen." %}
...
{% include picture.html img="phase-2-execution.png" alt="Sekiro preparing to execute Isshin, the Sword Saint, in Phase 2 of the final boss battle." %}
...
{% include picture.html img="well-done-sekiro.png" alt="Isshin Ashina is executed by Sekiro, who wields the Immortal Blade. Isshin's last dying words appear on screen as he draws his last breath: 'Well... done... Sekiro.'" %}
...
<div class='embed-container'><iframe src='https://www.youtube.com/embed//Ewu-Evc_qNc' frameborder='0' allowfullscreen></iframe></div>
