...
{% include img.html src: "./images/google-search.jpg", alt: "Google searches that begin with 'ar'" %}
...
{% include img.html src: "./images/trie.jpg", alt: "An example of a trie for the words bat, big, ape, and apple." %}
...
{% include img.html src: "./images/wrong-find.jpg", alt: "An example of a false match for a word in a trie." %}
...
{% include img.html src: "./images/right-find.jpg", alt: "An example of inserting the words app and apple into a trie." %}
...
{% include img.html src: "./images/test-output.jpg", alt: "Test output: 8 cases passed" %}
