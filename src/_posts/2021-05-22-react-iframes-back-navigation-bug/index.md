...
![A page rendering three navigation links and an iframe to the right. The iframe shows a number in large font denoting which page it corresponds to. Currently, the iframe shows a 1, and page 1 of 3 is selected in the navigation tree.](./images/forward-navigation-1.png)

You then visit the second page, and it updates the iframe:

![A page rendering three navigation links and an iframe to the right. The iframe shows a number in large font denoting which page it corresponds to. Currently, the iframe shows a 2, and page 2 of 3 is selected in the navigation tree.](./images/forward-navigation-2.png)

Finally, you visit the third page, and it too renders the correct iframe:

![A page rendering three navigation links and an iframe to the right. The iframe shows a number in large font denoting which page it corresponds to. Currently, the iframe shows a 3, and page 3 of 3 is selected in the navigation tree.](./images/forward-navigation-3.png)
...
![A page rendering three navigation links and an iframe to the right. The iframe shows a number in large font. Currently, the iframe shows a 2, but the page navigation is stuck on page 3 of 3.](./images/back-navigation-32.png)
...
![A page rendering three navigation links and an iframe to the right. The iframe shows a number in large font. The iframe and page navigation are now in sync; the iframe shows a big number 2, and the nav tree is on page 2 of 3.](./images/back-navigation-22.png)
