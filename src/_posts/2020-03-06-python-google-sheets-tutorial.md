...
{% include img.html img="create-project.gif" alt="Creating a Google Cloud Platform project." %}
...
{% include img.html img="enable-sheets-api.gif" alt="Enabling the Google Sheets API." %}
...
{% include img.html img="create-credentials.gif" alt="Creating Google API credentials." %}
...
{% include img.html img="enable-drive-api.gif" alt="Enabling the Google Drive API." %}
...
{% include img.html img="service-accounts.png" alt="Google Cloud service accounts for a project." %}

Once you have the email, click `Share` in your spreadsheet and paste it in:

{% include img.html img="share.gif" alt="Sharing your spreadsheet with the client email you set up earlier." %}

You may get a mail delivery failure message in your Gmail inbox shortly after you do this:

{% include img.html img="mail-delivery-failure.png" alt="Mail delivery failure." %}
...
{% include img.html img="run.gif" alt="Running a Python script that pushes data to Google Sheets." %}
