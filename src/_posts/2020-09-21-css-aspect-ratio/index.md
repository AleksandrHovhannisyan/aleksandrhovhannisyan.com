...
<ol class="demo-square-grid" aria-hidden="true">
  {% for i in (1..3) %}
  <li class="demo-square">{% include postImage.html src: "./images/puppy.png", alt: "", clickable: false %}</li>
  {% endfor %}
  {% for i in (1..3) %}
  <li class="demo-square">{% include postImage.html src: "./images/kitten.png", alt: "", clickable: false %}</li>
  {% endfor %}
  {% for i in (1..3) %}
  <li class="demo-square">{% include postImage.html src: "./images/parakeet.png", alt: "", clickable: false %}</li>
  {% endfor %}
</ol>
