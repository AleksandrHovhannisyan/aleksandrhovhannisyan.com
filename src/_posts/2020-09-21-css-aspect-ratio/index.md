...
{% include img.html src: "./images/default-aspect-ratio.png", alt: "The default aspect ratio for an image is observed to be 500 / 300 in Chrome dev tools." %}
...
<ol class="demo-square-grid" aria-hidden="true">
  {% for i in (1..3) %}
  <li class="demo-square">{% include img.html src: "./images/puppy.png", alt: "", clickable: false %}</li>
  {% endfor %}
  {% for i in (1..3) %}
  <li class="demo-square">{% include img.html src: "./images/kitten.png", alt: "", clickable: false %}</li>
  {% endfor %}
  {% for i in (1..3) %}
  <li class="demo-square">{% include img.html src: "./images/parakeet.png", alt: "", clickable: false %}</li>
  {% endfor %}
</ol>
...
{% include img.html src: "./images/grid.png", alt: "Inspecting a grid of four items with the Chrome dev tools reveals that each grid items has its own block formatting context, shown with a dashed outline." %}
...
{% include img.html src: "./images/horizontal-mode.png", alt: "A horizontal writing mode, with text flowing vertically from top to bottom. An arrow points from left to right at the top of the document and is labeled as the inline direction. Another arrow points from top to bottom and is labeled as the block direction.", caption: "Horizontal writing mode (default)." %}

{% include img.html src: "./images/vertical-mode.png", alt: "A vertical writing mode, with text flowing horizontally. The horizontal axis is labeled as the block direction, whereas the vertical axis is now labeled as the inline direction. Text is rendered sideways.", caption: "Vertical writing mode." %}
