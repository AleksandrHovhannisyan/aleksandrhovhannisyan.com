...
import { escapeString, slugifyString } from './lib/utils.js';
...
export default function eleventy(eleventyConfig) {
	...
	eleventyConfig.addFilter('escape', escapeString);
	...
	eleventyConfig.addPlugin(PluginFootnotes, {
		...
		backLinkLabel: (_footnote, index) => `Back to reference ${index + 1}`,
	});
