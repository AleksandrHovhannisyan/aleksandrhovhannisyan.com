...
description: Jekyll is a static site generator that makes it easy to create your first website, which you can even host for free on GitHub Pages.
...
![A static site generator spits out a compiled, well-structured, fully functioning site.](./images/static-site-generator.png)
...
![Click the green new button to create a repository.](./images/new-repo.png)

Enter the name of your repository. It needs to be your GitHub username followed by `.github.io`:

![Type in the name of your new repository.](./images/create-repo.png)
...
![Jekyll starter files.](./images/directory-structure.jpg)
...
![The three Jekyll starter themes.](./images/themes.jpg)
...
![The WEBrick server for our Jekyll site.](./images/webrick.png)
...
![The WEBrick server for our Jekyll site.](./images/webrick2.png)
...
![A sample blog post.](./images/post.png)
...
![A sample blog post showing its date in the body.](./images/date.png)
...
![The starter blog post has a collapsed layout.](./images/collapsed-layout.png)
...
![The post layout.](./images/post-layout.png)
...
![The styled version of the site.](./images/styled.png)
...
![Mockups of project cards and skills](./images/mockup.png)
...
![Google Search Console statistics for my site.](./images/google-search-console.png)
...
![Adding a Google Search Console property.](./images/add-property.png)

When prompted to select a property type, choose the `URL prefix` option and enter the full URL of your site on GitHub Pages:

![Selecting the type of property in Google Search Console.](./images/property-type.png)
...
![Verify ownership of your Google Search Console property.](./images/verify-ownership.png)
