...
![Undraw illustrations showing blue people in different settings, like freelancing or pointing at charts and graphs.](./images/undraw.png)
...
![Humaaans illustrations showing faceless people in blue clothing](./images/humaaans.png)
...
![Slack's landing page shows a colorful demo of two people using the app](./images/slack.png)
...
![Medium's landing page cuts straight to the chase by allowing you to pick the topics that you're interested in reading, with a simple 'Get Started' call-to-action button.](./images/medium.png)
...
![Visual Studio Code's landing page has a download button to the left and a screenshot of the editor to the right](./images/vscode.png)
...
![Shopify's landing page shows a woman at her laptop, presumably on her Shopify account, with shelves stocked full of jars behind her.](./images/shopify.png)
...
![KhanAcademy's landing page shows children of all ages and backgrounds at their laptops, smiling and engaged in learning](./images/khanacademy.png)
...
![Gmail's landing page has a call to action on the left to create an account, with a graphic on the right for Google Meet showing a bunch of people in a conference](./images/gmail.png)
...
![Quora's landing page background shows an assortment of colorful and quirky illustrations reminiscent of a Where's Waldo type of setting](./images/quora.png)
