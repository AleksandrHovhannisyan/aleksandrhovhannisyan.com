...
<div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 0.625rem; max-width: 400px;" aria-hidden="true">
  {%- for i in (1..9) -%}
    <div style="background: var(--color-surface-2); aspect-ratio: 1; display: flex; justify-content: center; align-items: center;">{{ i }}</div>
  {%- endfor -%}
</div>
...
<div class="flex-center text-center" style="background: var(--color-surface-2); aspect-ratio: 1; max-width: {{ squareDemoMaxWidth }}; padding: var(--size-spacing-5); color: var(--color-text-emphasis);" aria-hidden="true">I'm a square. My max width is {{ squareDemoMaxWidth }}.</div>
...
<div class="circle flex-center text-center" style="background: var(--color-surface-2); max-width: {{ squareDemoMaxWidth }}; padding: var(--size-spacing-5); color: var(--color-text-emphasis);" aria-hidden="true">I'm a circle.</div>
