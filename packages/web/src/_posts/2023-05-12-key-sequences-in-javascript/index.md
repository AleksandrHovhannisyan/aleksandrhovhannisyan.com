...
<code-demo description="Listening for the key sequence abc, with a two-second delay between a and b and a one-second delay between b and c." style="height: 310px">
  <template>
    <table>
      <thead>
        <tr>
