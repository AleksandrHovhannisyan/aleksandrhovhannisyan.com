...
description: Rems are the most accessible CSS unit for font size, allowing text to scale responsively when users change their preferred font size settings.
