...
{% aside %}
  **Update**: Eleventy v3.0 now has a much simpler solution for image optimization. See this article: [Eleventy Images Just Got Better](/blog/eleventy-image-transform/).
{% endaside %}
