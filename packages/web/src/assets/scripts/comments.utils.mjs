...
export const fetchComments = async (id) => {
  try {
    ...
    /** @type import("../../../lib/types/comments").PostComment[] */
...
/** @param {import("../../../lib/types/comments").PostComment} comment The user comment to render. */
...
/** @param {import("../../../lib/types/comments").PostComment[]} comments The user comments to render. */
