...
{% include picture.html img="dashboard" ext="PNG" alt="The Netlify dashboard for my personal website" shadow=false %}
...
{% include picture.html img="faster-deploys" ext="PNG" alt="Netlify deploys my site very quickly" shadow=false %}
...
{% include picture.html img="migration" ext="PNG" alt="Migrating my old search engine results to my new domain" shadow=false %}
