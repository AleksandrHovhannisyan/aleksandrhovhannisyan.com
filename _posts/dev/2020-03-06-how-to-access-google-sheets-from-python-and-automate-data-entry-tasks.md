---
title: "How to Access Google Sheets From Python and Automate Data Entry Tasks"
description: In this short tutorial, I'll show you how to access Google Sheets from Python so you can automate data entry tasks in your day-to-day work. This is pretty much a game-changer if you're used to manual data entry.
keywords: [access google sheets from python, automate data entry]
...
In this short tutorial, I'll show you how to access Google Sheets from Python so you can automate data entry tasks in your day-to-day work. This is pretty much a game-changer if you're used to manual data entry, so buckle up!

## How to Create a Google Cloud Platform Project
...
{% include posts/picture.html img="enable-drive-api" ext="GIF" alt="Enabling the Google Drive API." shadow=false %}
