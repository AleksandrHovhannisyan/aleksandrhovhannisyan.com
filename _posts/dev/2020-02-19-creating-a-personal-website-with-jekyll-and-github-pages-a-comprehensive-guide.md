---
title: "Creating a Personal Website with Jekyll and GitHub Pages: A Comprehensive Guide"
...
Want to make a personal website or blog and share it with the world? Then you've come to the right place!

This is the only guide you'll need to get started with Jekyll and host your site for free on GitHub Pages. I'll take you from zero to hero with Jekyll and help you understand all the fundamentals.
...
{% include posts/picture.html img="new-repo" ext="PNG" alt="Click the green new button to create a repository." shadow=false %}

Enter the name of your repository. It needs to be your GitHub username followed by `.github.io`:

{% include posts/picture.html img="create-repo" ext="PNG" alt="Type in the name of your new repository." shadow=false %}
...
{% include posts/picture.html img="directory-structure" ext="JPG" alt="Jekyll starter files." shadow=false %}
...
{% include posts/codeHeader.html name="Gemfile" %}
```ruby
...
{% include posts/codeHeader.html name="_config.yml" %}
```yml
# Welcome to Jekyll!
#
...
{% include posts/picture.html img="hello-jekyll" ext="PNG" alt="Hello, Jekyll" %}
...
{% include posts/codeHeader.html name="_site/index.html" %}
```html
<h1 id="hello-jekyll">Hello, Jekyll!</h1>
```
...
{% include posts/codeHeader.html name="_posts/2020-02-14-an-awesome-post.md" %}
```markdown
---
isPost: true
layout: post
...
{% include posts/picture.html img="webrick" ext="PNG" alt="The WEBrick server for our Jekyll site." %}
...
{% include posts/codeHeader.html name="_pages/index.md" %}
```markdown
---
permalink: /
---
...
{% include posts/codeHeader.html name="_pages/about.md" %}
```markdown
---
layout: page
title: About
...
{% include posts/picture.html img="about" ext="GIF" alt="Navigating to the About page." %}
...
{% include posts/picture.html img="post" ext="PNG" alt="A sample blog post." %}

Below is the updated `_site/` directory. Notice that now, instead of creating subdirectories for the year, month, and day when a post was published, Jekyll creates subdirectories by nesting categories, then creating one more directory with the post title, and finally placing `index.html` in there:
...
{% include posts/picture.html img="date" ext="PNG" alt="A sample blog post showing its date in the body." %}
...
{% include posts/codeHeader.html name="_pages/blog.md" %}
{% raw %}
```markdown
---
layout: default
...
{% include posts/codeHeader.html name="_layouts/default.html" %}
{% raw %}
```html
<!DOCTYPE html>
<html lang="en">
...
{% include posts/picture.html img="default-layout" ext="GIF" alt="The default layout." %}
...
If we open up the starter blog post that we saw earlier, you'll notice that it has a different layout set:
...
{% include posts/picture.html img="collapsed-layout" ext="PNG" alt="The starter blog post has a collapsed layout." %}
...
{% include posts/codeHeader.html name="_layouts/post.html" %}
{% raw %}
```html
---
layout: default
...
{% include posts/picture.html img="post-layout" ext="PNG" alt="The post layout." %}
...
{% include posts/codeHeader.html name="`/assets/styles/main.scss`" %}
```scss
---
---
...
{% include posts/codeHeader.html name="_sass/_general.scss" %}
```scss
* {
...
{% include posts/codeHeader.html name="_site/assets/styles/main.css" %}
```css
...
{% include posts/picture.html img="styled" ext="PNG" alt="The styled version of the site." %}
...
{% include posts/codeHeader.html name="_includes/tooltip.html" %}
{% raw %}
```html
...
{% include posts/picture.html img="mockup" ext="PNG" alt="Mockups of project cards and skills" shadow=false %}
...
{% include posts/codeHeader.html name="_data/skills.yml" %}
```yaml
- name: Writing
  rating: 5
- name: Jekyll
...
{% include posts/codeHeader.html name="_pages/experience.md" %}
{% raw %}
```liquid
<ul>
...
Also, note that you can nest arrays in YAML and in Liquid, so you could—like I do on this site—define skill *categories* and nest the actual skills within them:
...
{% include posts/codeHeader.html name="_data/authors.yml" %}
```yml
John Doe:
  photo: john-doe.JPG
...
{% include posts/codeHeader.html name="_posts/2020-02-13-a-really-awesome-post.md" %}
{% raw %}
```markdown
---
...
{% include posts/codeHeader.html name="_data/tagDescriptions.yml" %}
```yaml
...
{% include posts/codeHeader.html name="_layouts/blog.html" %}
{% raw %}
```liquid
...
{% include posts/picture.html img="add-property" ext="PNG" alt="Adding a Google Search Console property." %}

When prompted to select a property type, choose the `URL prefix` option and enter the full URL of your site on GitHub Pages:

{% include posts/picture.html img="property-type" ext="PNG" alt="Selecting the type of property in Google Search Console." %}
...
{% include posts/picture.html img="verify-ownership" ext="PNG" alt="Verify ownership of your Google Search Console property." %}
