...
{% include picture.html img="google-search" ext="JPG" alt="Google searches that begin with 'ar'" shadow=false %}
...
{% include picture.html img="wrong-find" ext="JPG" alt="An example of a false match for a word in a trie." %}
...
{% include picture.html img="right-find" ext="JPG" alt="An example of inserting the words app and apple into a trie." %}
...
{% include picture.html img="test-output" ext="JPG" alt="Test output: 8 cases passed" %}
