...
{% include picture.html img="pagespeed-insights.png" alt="The PageSpeed Insights score for one of my blog posts." %}
...
{% include picture.html img="demo.gif" alt="Converting a traditional image format to a webp image." %}
...
{% include picture.html img="caniuse.jpg" alt="The caniuse results for WebP" %}
...
{% include picture.html img="assets.jpg" alt="My assets/img/posts folder." %}
