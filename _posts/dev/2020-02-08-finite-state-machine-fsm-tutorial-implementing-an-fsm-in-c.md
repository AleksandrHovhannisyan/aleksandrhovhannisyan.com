...
{% include posts/picture.html img="fsm" ext="JPG" alt="A finite state machine representation." shadow=false %}
...
{% include posts/codeHeader.html name="LightState.h" %}
```cpp
#pragma once
...
{% include posts/codeHeader.html name="Light.h" %}
```cpp
#pragma once
...
{% include posts/codeHeader.html name="Light.cpp" %}
```cpp
#include "Light.h"
...
{% include posts/picture.html img="light-fsm" ext="JPG" alt="Modeling our lightbulb's FSM." shadow=false %}
...
{% include posts/codeHeader.html name="ConcreteLightStates.h" %}
```cpp
#pragma once
#include "LightState.h"
#include "Light.h"
...
{% include posts/codeHeader.html name="ConcreteLightStates.cpp" %}
```cpp
...
{% include posts/picture.html img="tests" ext="JPG" alt="All tests passed successfully in Visual Studio." %}
