...
{% include picture.html img="demo" ext="gif" alt="A demo of opening and closing stacked modals." %}

The second is opening multiple modals on one page side by side:

{% include picture.html img="side-by-side-demo" ext="gif" alt="A demo of opening and closing side-by-side modals." %}
...
{% include picture.html img="modal" ext="png" alt="One of the modals we created, with its slightly opaque background." %}
