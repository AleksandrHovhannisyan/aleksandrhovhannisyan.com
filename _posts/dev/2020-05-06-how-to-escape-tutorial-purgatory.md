...
<figure>
    {% include picture.html img="tools" ext="PNG" alt="xkcd comic about tools" %}
...
{% include picture.html img="udemy" ext="PNG" alt="Software development courses on sale on Udemy." %}
...
{% include picture.html img="distractions" ext="PNG" alt="Distractions, distractions everywhere." %}
