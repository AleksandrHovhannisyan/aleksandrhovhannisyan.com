...
<figure>
    {% include posts/picture.html img="tools" ext="PNG" alt="xkcd comic about tools" shadow=false %}
...
{% include posts/picture.html img="udemy" ext="PNG" alt="Software development courses on sale on Udemy." shadow=false %}
...
[I've written about this before](https://aleksandrhovhannisyan.github.io/blog/dev/learn-to-code-without-wasting-time-and-money/#stop-wasting-money-on-courses-you-ll-never-finish), and I'll say it again: Don't waste money buying courses when there's such a wealth of free information available online. Price tags don't imply any inherent value.
...
{% include posts/picture.html img="distractions" ext="PNG" alt="Distractions, distractions everywhere." shadow=false %}
