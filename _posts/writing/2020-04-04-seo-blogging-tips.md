...
{% include posts/picture.html img="metrics" ext="PNG" alt="Tracking metrics for a website." shadow=false %}
...
<figure>
  {% include posts/picture.html img="trending" ext="PNG" alt="One of my pages is trending up in search results after recent SEO efforts." shadow=false %}
...
<figure>
    {% include posts/picture.html img="keyword-stuffing" ext="PNG" alt="An example of keyword stuffing, straight from Google." shadow=false %}
...
<figure>
    {% include posts/picture.html img="difficult-keyword" ext="PNG" alt="A keyword that would be very difficult to rank for." shadow=false %}
...
<figure>
    {% include posts/picture.html img="easier-keyword" ext="PNG" alt="A keyword that's much easier to rank for." shadow=false %}
...
{% include posts/picture.html img="google-search-suggestions" ext="PNG" alt="Google Search suggestions for 'best workouts.'" shadow=false %}
...
{% include posts/picture.html img="google-trends" ext="PNG" alt="Google Trends results comparing two search terms" shadow=false %}
...
{% include posts/picture.html img="ubersuggest" ext="PNG" alt="Ubersuggest gives you a detailed breakdown of keyword data." shadow=false %}
...
{% include posts/picture.html img="google-search-console" ext="PNG" alt="Google Search Console results for my site over the past 3 months." shadow=false %}
...
{% include posts/picture.html img="pagespeed-insights" ext="PNG" alt="PageSpeed Insights results for a post from my website." shadow=false %}
...
{% include posts/picture.html img="ideas" ext="PNG" alt="All ideas grow out of other ideas." shadow=false %}
...
{% include posts/picture.html img="quora-authority" ext="PNG" alt="Quora has a very high domain authority." shadow=false %}
{% include posts/picture.html img="stackoverflow-authority" ext="PNG" alt="StackOverflow also has a very high domain authority." shadow=false %}
...
{% capture code %}{% raw %}<script type="application/ld+json">
  {
    ...
    "image": ["{{ site.url }}/assets/img/posts/{{ page.slug }}/og.JPG"],
