...
Leetcode is the same. There's this pervasive (and arguably harmful) practice in the hiring industry where a programmer's aptitude is measured by their ability to solve coding puzzles on a whiteboard, and that has spawned a number of platforms like Leetcode dedicated to helping developers master the art of solving obscure problems. I've personally been fortunate enough to not have to go through this ordeal in my interviews, and I hope you don't either.
