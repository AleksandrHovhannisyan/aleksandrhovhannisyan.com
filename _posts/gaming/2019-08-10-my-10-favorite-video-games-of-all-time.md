...
<figure>
    {% include picture.html img="minish-cap-intro" ext="JPG" alt="Intro text from the Legend of Zelda: The Minish Cap." %}
...
<figure>
    {% include picture.html img="arrow-knee" ext="JPG" alt="A Dawnstar Guard saying the infamous 'Arrow in the Knee' quote." %}
...
<figure>
    {% include picture.html img="dark-souls-2" ext="JPG" alt="Dark Souls 2 player dressed in Knight Armor facing a dragon at Dragon Aerie." %}
...
<figure>
    <picture>
        {% include picture.html img="dark-souls-3" ext="JPG" alt="The sandy ruins of the Ringed City." %}
    </picture>
...
{% include picture.html img="hollow-knight" ext="JPG" alt="The Memorial to the Hollow Knight. The text reads: 'In the Black Vault far above. Through its sacrifice Hallownest lasts eternal.'" %}
...
{% include picture.html img="hk-greenpath" ext="JPG" alt="Greenpath, one of the early areas in Hollow Knight. It's characterized by lush green forests and cute little bugs." %}
...
{% include picture.html img="prince-combat" ext="JPG" alt="The top and bottom screens of the Battles of the Prince of Persia." %}
...
{% include picture.html img="prince-card" ext="JPG" alt="Zeal, one of the many cards that you can play in Battles of the Prince of Persia." %}
...
{% include picture.html img="metro" ext="JPG" alt="Operation Metro on the Xbox One" %}
...
{% include picture.html img="pawns" ext="JPG" alt="The Rift, a shadowy realm in Dragon's Dogma Dark Arisen from which the player can enlist Pawns to join their party." %}
...
<figure>
{% include picture.html img="bolide" ext="JPG" alt="Player casting the spell Grand Bolide, which summons meteors from the sky." %}
...
<figure>
{% include picture.html img="inside" ext="JPG" alt="An underwater scene from the game." %}
...
<figure>
    {% include picture.html img="dishonored-intro" ext="JPG" alt="Corvo Attano being apprehended and arrested for the murder of the Empress." %}
...
<figure>
    {% include picture.html img="corvo-drawing" ext="JPG" alt="Corvo looking over Lady Emily's shoulder as she draws a picture of him." %}
